...
export declare class MzCollapsibleComponent implements AfterViewInit, OnDestroy {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<MzCollapsibleComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<MzCollapsibleComponent, "mz-collapsible", never, { "mode": "mode"; "onClose": "onClose"; "onOpen": "onOpen"; "popout": "popout"; }, {}, ["items"], ["*"]>;
}
