...
export declare class MzSelectDirective extends HandlePropChanges implements OnInit, OnDestroy {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<MzSelectDirective, never>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDefWithMeta<MzSelectDirective, "select[mzSelect], select[mz-select]", never, { "id": "id"; "disabled": "disabled"; "placeholder": "placeholder"; "label": "label"; "filledIn": "filledIn"; }, { "update": "update"; }, never>;
}
